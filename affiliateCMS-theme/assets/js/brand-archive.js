/**
 * Brand Archive - Load More Products
 *
    ...
    const brandLoadMore = {
        ...
        async loadMore() {
            ...
            try {
                ...
                formData.append('action', 'acms_load_more_brand_products');
                formData.append('nonce', acmsBrandAjax.nonce);
                formData.append('brand', this.brand);
                formData.append('offset', this.offset);
                formData.append('per_page', this.perPage);

                const response = await fetch(acmsBrandAjax.ajaxUrl, {
                    method: 'POST',
                    body: formData,
                });
